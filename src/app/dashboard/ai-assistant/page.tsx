...
export default function AiAssistantPage() {
  ...
  return (
    <div className="flex h-[calc(100vh-140px)] flex-col overflow-hidden rounded-3xl bg-[#f6f4fb] shadow-sm ring-1 ring-black/[0.04]">
      {/* header — branded: back, logo, name, online, menu */}
      <div className="flex items-center gap-2 border-b border-border/60 bg-white px-2 py-2">
